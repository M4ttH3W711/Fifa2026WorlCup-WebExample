...
export const FavsFilledIcon: React.FC<IconProps> = ({ size = 18, color = "currentColor" }) => (
  <svg
    ...
    height={size}
    viewBox="0 0 24 24"
    fill={color} /* ← ahora el relleno es del mismo color que el contorno */
    stroke={color}
    strokeWidth="1.5"
    strokeLinecap="round"
    strokeLinejoin="round"
...
/* ❤️ Icono de Favoritos (quitar) - corazón relleno */
